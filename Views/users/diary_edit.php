...
$result = $params->getMyDiary();
$id = $result['getMyDiary']['id'];
// if ($result) {
...
<body>
  ...
  <div class="container py-4" id="contact">
    <h1 class="text-center">記事編集画面</h1>
    <form action="../users/diary_edit.php?id=<?php echo $result['getMyDiary']['id'] ?>" method="POST">
      <div class="form-group">
        ...
        placeholder="<?php echo $result['getMyDiary']['title']?>">
      </div>
      <div class="form-group">
        <label for ="body">body:<?php echo isset($err['body']) ? $err['body'] : ''; ?></label>
        <textarea name="body" class="form-control" value="<?php echo isset($_POST['body']) ? htmlspecialchars($_POST['body'], ENT_QUOTES) : ''; ?>" placeholder="<?php echo $result['getMyDiary']['body']?>"></textarea>
      </div>
